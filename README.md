...
**The research data used for the AluTrace use is provided in this repository. It is organized to enable reuse for several [purposes](https://github.com/Mat-O-Lab/AluTrace-Data-and-Documentation/blob/main/src/RDF%20data%20and%20ontologies/README.md#Use-cases-of-this-data).** 
